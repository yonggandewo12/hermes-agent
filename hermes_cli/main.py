...
"""
    ...
    gateway_parser = subparsers.add_parser(
        ...
        description="Manage the messaging gateway (Telegram, Discord, Slack, and more)"
    )
    ...
    cron_create.add_argument("--deliver", help="Delivery target: origin, local, telegram, discord, or platform:chat_id")
    ...
    pairing_approve_parser.add_argument("platform", help="Platform name (telegram, discord, slack)")
